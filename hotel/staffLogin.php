...
<!--The code below displays a view of staff login that shows the text blocks 
for entering staff credentials and navigating to staff homepage on successful login.-->
...
and embedding the menu bar from the menu.php file. This file includes options such as 
Home, About, Login, Gallery, Contact, and Login has additional login options such as Customer Login, Admin Login, and Staff Login.
-->
...
<!-- to show staff login page which includes username and password text fields and a login button , 
if the entered username and password exist in database and login is successful the page is redirected 
to staff home page else displays an error message "Wrong Username and Password"-->  
...
<section id="book-a-table" class="book-a-table">
    <div class="container">
      ...
      <div class="section-title">
        ...
        ?>
      <!-- It takes in usernames and passwords as inputs, and a string error message is returned 
      if the inputs do not comply with the data validations.
      -->
